...
<center><b><span style="position:relative;top:7px;font-family:monospace;font-size:17px;text-decoration:none;">Friend's</spna></center></b>
<hr></hr>
</div>
<?php 
$user_id=$_SESSION['id'];
...
$followers->sql_high("friend","follow_to",null,"follow_by=$user_id");
...
<a href=""><img src="image/profile.png" width="100%" height="100%" ></a>
</div>
...
<div class="flw" style="background-color:cyan;cursor:pointer;float:right;width:100px;height:25px;margin-top:-30px;margin-right:20px;border-radius:5px;">
