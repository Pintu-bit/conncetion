...
<center><b><span style="position:relative;top:7px;font-family:monospace;font-size:17px;text-decoration:none;">All Friend's</span></center></b>
<hr></hr>
</div>
<?php 
  ...
  if(isset($_GET['id']) && $_GET['id']>0)
   {
	$user_id=$_SESSION['id'];
	$friend_user=$_GET['id'];
   $followers->sql_high("friend","follow_to,follow_by",null,"(follow_by=$friend_user || follow_to=$friend_user) && accept_sts=1");
...
<a href="profile.php?id=<?php print_r($followers_userResult[0]['user_id']);?>"><img src="web_image/
<?php
if($followers_userResult[0]['profile_img'])
{
 print_r($followers_userResult[0]['profile_img']);
}
else
{
    echo "user.png";
...
<a href=""><span style="float:left;margin-left:70px;margin-top:-30px;font-family:monospace;font-size:14px;"><?php print_r($followers_userResult[0]['name']); ?></span></a>
<div class="flw" data-sender="<?php print_r($follow_result[$i]['follow_to']);?>" style="background-color:cyan;cursor:pointer;float:right;width:100px;height:25px;margin-top:-30px;margin-right:20px;border-radius:5px;">
<center><b><span style="position:relative;top:2px;font-family:monospace;font-size:14px;text-decoration:none;">Remove</p></center></b>
</div>
</div>
<?php 
}
...
function create_notification(){
	var model_content="";
  model_content+='<div class="div_scroll" id="noti" style="overflow-x: hidden;border-radius:10px;position:relative;left:23%;top:30px;width:400px;height:600px;z-index:999;border:;background-color:#d6d6d6;overflow-y:scroll;">';
